...
ноутбук
    12
'''
scrabble_dict = dict(A=1, E=1, I=1, O=1, U=1, L=1, N=1, S=1, T=1, R=1, D=2, G=2,
                     B=3, C=3, M=3, P=3, F=4, H=4, V=4, W=4, Y=4, K=5, J=8, X=8,
                     Q=10, Z=10, А=1, В=1, Е=1, И=1, Н=1, О=1, Р=1, С=1, Т=1, 
                     Д=2, К=2, Л=2, М=2, П=2, У=2, Б=3, Г=3, Ё=3, Ь=3, Я=3, Й=4,
                     Ы=4, Ж=5, З=5, Х=5, Ц=5, Ч=5, Ш=8, Э=8, Ю=8, Ф=10, Щ=10, Ъ=10,
                     a=1, e=1, i=1, o=1, u=1, l=1, n=1, s=1, t=1, r=1, d=2, g=2,
                     b=3, c=3, m=3, p=3, f=4, h=4, v=4, w=4, y=4, k=5, j=8, x=8,
                     q=10, z=10, а=1, в=1, е=1, и=1, н=1, о=1, р=1, с=1, т=1, 
                     д=2, к=2, л=2, м=2, п=2, у=2, б=3, г=3, ё=3, ь=3, я=3, й=4,
                     ы=4, ж=5, з=5, х=5, ц=5, ч=5, ш=8, э=8, ю=8, ф=10, щ=10, ъ=10)
...
for i in range(len(word)):
    word_key = scrabble_dict.get(word[i])
    sum_word_keys = sum_word_keys + word_key
print(sum_word_keys)
